...
import com.sdc.api.services.RegraService;
...
public class RegraController {
	 ...
	 */
	@GetMapping(value = "/{id}")
	public /*ResponseEntity<Response<RegraDto>>*/ void buscarPorId(@PathVariable("id") int id) {
	...
	public /*ResponseEntity<Response<RegraDto>>*/ void buscarPorNome(@PathVariable("nome") String nome) {
		/*Response<RegraDto> response = new Response<RegraDto>();
		try {
	...
	public /*ResponseEntity<Response<List<RegraDto>>>*/ void buscarTodasAsRegras() {
