...
public class RegraService {
	...
	public Optional<Regra> buscarPorId(int id) {
		...
		if (!regra.isPresent()) {
			...
			/*
			 * throw new ConsistenciaException("Nenhuma regra com id: {} foi encontrada",
			 * id);
			 */
		}
		return regra;
	...
	public Optional<Regra> buscarPorNome(String nome) {
		...
		if (!regra.isPresent()) {
			...
			/*
			 * throw new ConsistenciaException("Nenhuma regra com nome: '{}' foi
			 * encontrada", nome);
			 */
		}
		return regra;
	...
	public Optional<List<Regra>> buscarTodasAsRegras() {
